...
CFLAGS = $(CFLAGS) /nologo /W3 /Zi /WX- /Od /MD /GF /Ob2 /Oi- /D_WIN32_WINNT=0x0501 /D "_DEBUG"
...
INC2 = $(INC) /Isrc
LIBS = ws2_32.lib libpq.lib
LINKOPTS = /nologo /subsystem:windows /incremental /DEBUG
